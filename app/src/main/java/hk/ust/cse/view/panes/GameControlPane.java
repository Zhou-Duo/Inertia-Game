...
public class GameControlPane extends GridPane implements GameUIComponent {
    ...
    /**
     * Delegate the control of movement from the GUI to an automated delegate.
    ...
    /**
     * Revoke the control from the delegate if there is any.
